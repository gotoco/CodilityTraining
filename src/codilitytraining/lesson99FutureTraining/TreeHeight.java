...
public class TreeHeight {
    ...
    static TreeHeight that = new TreeHeight();
    ...
    public static void example(){
        ...
        System.out.println("For exaple solution should return 2 : " + that.solution(root));
    }
    ...
    public int solution(Tree T) {
        ...
        int max = Math.max(this.solution(T.l), this.solution(T.r));
