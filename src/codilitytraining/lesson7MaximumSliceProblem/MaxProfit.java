...
public class MaxProfit {
    ...
    public static void main(String[] args){
        ...
        MaxProfit d = new MaxProfit();
        int [] testCase1 = {23171, 21011, 21123, 21366, 21013, 21367, };

        System.out.println("First test case should return  356 : " + d.solution(testCase1));
    }
    ...
    public int solution(int[] A){
        ...
        for(int i=0; i<n-1; i++){
            ...
            currentProfit = currentProfit+A[i+1]-A[i] ;
